...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm('service_hhnerfa', 'template_yhiij1c', form.current, 'SwoZ47ED07fwJxuEw')
        e.target.reset();
    };
    return (
            ...
            <div className="contact__content">
                ...
                <div className="contact__info">
                    <div className="contact__card">
                        ...
                        <span className="contact__card-data">rishabh.kala2003@gmail.com</span>
                         
                        <a href="mailto:rishabh.kala2003@gmail.com" className="contact__button">
                            Write Me{" "} 
